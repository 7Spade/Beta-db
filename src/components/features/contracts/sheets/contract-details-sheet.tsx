                  ...
                  <Table>
                    ...
                    <TableBody>
                      {contract.changeOrders.length > 0 ? contract.changeOrders.map((order) => (
                        ...
                        <TableRow><TableCell colSpan={4} className="text-center h-24">尚無變更單紀錄</TableCell></TableRow>
                      )}
                    </TableBody>
                  </Table>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                   <div className="space-y-4">
                    {contract.versions.length > 0 ? contract.versions.map((version, index) => (
                      ...
                      <div className="text-center text-muted-foreground py-8">尚無版本紀錄</div>
                    )}
                  </div>
                </CardContent>
              </Card>
