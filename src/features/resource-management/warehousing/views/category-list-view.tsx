/**
 * @fileoverview Category List View
 * @description Unified view component for managing inventory categories with data fetching and client interactions.
 */
'use client';
                            ...
                            <TableBody>
                                {initialCategories.map((cat) => (
                                    <TableRow key={cat.id}>
                                        ...
                                        <TableCell>{cat.createdAt ? formatDate(cat.createdAt) : '-'}</TableCell>
