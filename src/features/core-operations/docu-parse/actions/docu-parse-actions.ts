 ...
 * - `src/features/core-operations/docu-parse/views/docu-parse-view.tsx`: 前端 UI，呼叫此處定義的 Actions。
 */

"use server";

import type { DocuParseActionState } from '@/features/core-operations/docu-parse/types';
