...
import { ComplianceTab } from '@/features/(resource-management)/(crm-management)/compliance/compliance-tab';
import { ContactsTab } from '@/features/(resource-management)/(crm-management)/contacts/contacts-tab';
import { ContractsTab } from '@/features/(resource-management)/(crm-management)/contracts/contracts-tab';
import { FinancialsTab } from '@/features/(resource-management)/(crm-management)/financials/financials-tab';
import { OverviewTab } from '@/features/(resource-management)/(crm-management)/overview/overview-tab';
import { PerformanceTab } from '@/features/(resource-management)/(crm-management)/performance/performance-tab';
import { TransactionsTab } from '@/features/(resource-management)/(crm-management)/transactions/transactions-tab';
