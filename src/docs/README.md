...
- **[進度計價與審批 (Progress Billing)](./4-system-blueprints/progress-billing.md)**
- **[成本與預算追蹤 (Cost Tracking)](./4-system-blueprints/cost-tracking.md)**
- **[工地日報 (Daily Reports)](./4-system-blueprints/daily-report.md)**
- **[資源與排程 (Resource Scheduling)](./4-system-blueprints/resource-scheduling.md)**
- **[倉儲管理 (Inventory)](./4-system-blueprints/inventory.md)**
- **[任務委派與驗收 (Delegation & Acceptance)](./4-system-blueprints/delegation-and-acceptance-system.md)**
- **[網路推播通知 (Web Push)](./4-system-blueprints/web-push-notifications.md)**
- **[動態內容管理 (CMS)](./4-system-blueprints/content-management.md)**
- **[部落格管理 (Blog Management)](./4-system-blueprints/blog-management.md)**
- **[職涯管理 (Career Management)](./4-system-blueprints/career-management.md)**
- **[聯絡管理 (Contact Management)](./4-system-blueprints/contact-management.md)**
- **[系統管理 (System Management)](./4-system-blueprints/system-management.md)**
